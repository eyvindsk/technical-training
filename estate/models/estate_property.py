...
class RealEstate(models.Model):
    ...
    salesman = fields.Many2one("res.users" string="Salesman" default=lambda self: self.env.user) #fields.Char()
    buyer = fields.Many2one("res.partner" string="Partner") #fields.Char()
